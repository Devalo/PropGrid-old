class AddConfirmableToDevise < ActiveRecord::Migration[6.0]
  # Note: You can't use change, as Tenant.update_all will fail in the down migration
  def up
    ...
    # Tenant.reset_column_information # Need for some types of updates, but not for update_all.
    # To avoid a short time window between running the migration and updating all existing
    # tenant as confirmed, do the following
